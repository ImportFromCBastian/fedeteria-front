...
export const ConsultaForm = ({
  ...
  return (
    <div className="grid gap-2">
      ...
      <button
        className="active:bg-primary/80 focus:ring-primary inline-flex items-center justify-center rounded-lg bg-fede-main px-4 py-2 text-sm font-medium text-white shadow-lg hover:scale-100 hover:bg-fede-hover-button focus:outline-none focus:ring-2 focus:ring-offset-2"
